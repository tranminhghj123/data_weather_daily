...
bash# Copy env template
cp .env.example .env
Edit .env:
bashPOSTGRES_USER=your_user
...
🌐 Services
ServiceURLCredentialsAirflowhttp://localhost:8081admin / adminStreamlithttp://localhost:8501—PostgreSQLlocalhost:5431your .env values

🔌 Connection Guide
ToolHostPortpgAdmin (local)localhost5431DuckDB (local)localhost5431Inside Docker containerspostgres5432
